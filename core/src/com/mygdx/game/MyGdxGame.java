...
public class MyGdxGame extends ApplicationAdapter {
	...
	private void inicializarTexturas(){
		...
		passaros[0] = new Texture("passaro3.png");
	...
	private void verificarEstadoJogo(){
		...
		if(estadoJogo == 0){
			...
			if(posicaoCanoHorizontal < -canoTopo.getWidth()){
				posicaoCanoHorizontal = LarguraDispositivo;
				posicaoVertical = random.nextInt(400) - 200;
				passouCano = false;
			}
	...
	private void desenharTexturas(){
		...
		batch.draw(canoBaixo, posicaoCanoHorizontal,
				alturaDispositivo / 2 - canoBaixo.getHeight() - espacoEntreCanos/2 + posicaoVertical);
		batch.draw(canoTopo, posicaoCanoHorizontal,
				alturaDispositivo / 2+espacoEntreCanos / 2 + posicaoVertical);
